"use client"
export default function Search({ toggleSearch }: { toggleSearch: Function }) {
  return (
    <section>
      <div
        className="hidden w-full h-full pt-[1.55rem] md:pt-[2rem] lg:pt-[3rem] desktop:pt-[4rem] bg-primary/90 fixed z-50 overflow-hidden"
        id="search"
      >
