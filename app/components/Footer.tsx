	...
	return (
		<footer className="bg-white dark:bg-black">
			<div className="container  pb-[2.8rem] md:pb-[4rem] xl:pb-[5.8rem] flex flex-col items-center gap-y-[1.5rem] text-center relative">
				...
				<p className="text-black dark:text-white font-DMSans text-xl">
					Brilliance, a creative portfolio theme
				</p>
				<p
					className="text-gray-600 dark:text-white text-base font-DMSans
          md:mt-[.4rem]"
				>
					&copy; 2022.Brilliance, made by
					<a
						className="text-accent dark:text-accent-400"
				...
				<ul className="flex flex-row items-center gap-x-[1.84rem]">
						...
						>
							...
							>
								<path
									...
									fillRule="evenodd"
									clipRule="evenodd"
									d="M0 2.11765C0 0.948103 0.948103 0 2.11765 0C2.67928 0 3.21791 0.223109 3.61505 0.620245C4.01219 1.01738 4.23529 1.55601 4.23529 2.11765C4.23529 3.28719 3.28719 4.23529 2.11765 4.23529C0.948103 4.23529 0 3.28719 0 2.11765ZM18.5295 11.0222C18.566 8.72979 17.0021 6.7209 14.7707 6.19401C13.2754 5.87203 11.7167 6.29425 10.5883 7.32695V6.88225C10.5883 6.58986 10.3513 6.35283 10.0589 6.35283H7.41186C7.11947 6.35283 6.88245 6.58986 6.88245 6.88225V17.4705C6.88245 17.7629 7.11947 17.9999 7.41186 17.9999H10.0589C10.3513 17.9999 10.5883 17.7629 10.5883 17.4705V11.4987C10.5622 10.4354 11.3033 9.50672 12.346 9.29636C12.9668 9.18919 13.6031 9.36403 14.0821 9.77337C14.561 10.1827 14.8328 10.784 14.8236 11.414V17.4705C14.8236 17.7629 15.0606 17.9999 15.353 17.9999H18.0001C18.2925 17.9999 18.5295 17.7629 18.5295 17.4705V11.0222ZM4.2353 6.88219V17.4704C4.2353 17.7628 3.99828 17.9998 3.70589 17.9998H1.05883C0.766445 17.9998 0.529419 17.7628 0.529419 17.4704V6.88219C0.529419 6.58981 0.766445 6.35278 1.05883 6.35278H3.70589C3.99828 6.35278 4.2353 6.58981 4.2353 6.88219Z"
									fill="#060606"
								/>
							</svg>
						</a>
