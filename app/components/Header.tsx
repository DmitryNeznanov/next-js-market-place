				...
				>
					<div className="flex flex-col justify-center gap-y-[4rem] md:gap-y-[5.5rem]">
						...
						<form className="container flex justify-center">
							<div className="max-w-[43.75rem] w-screen flex flex-row items-center justify-between border-b-[.0625rem] border-b-black">
								<input
									className="block w-full input-primary placeholder:capitalize"
									type="text"
