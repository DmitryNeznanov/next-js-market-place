...
export default function Header() {
	...
	function openSearch() {
		const menu = document.getElementById('search') as HTMLDivElement
		menu.style.display = 'block'
	}
	...
	return (
		<header>
			...
			<section>
				<div
					className="hidden w-[100%] h-[100%] pt-[2rem] bg-black/90 dark:bg-white/90 overflow-hidden fixed"
					id="search"
				>
					<div className="flex flex-col justify-center gap-y-[4rem] md:gap-y-[5.5rem]">
						<div className="container flex flex-row justify-between">
							...
							<button>
								<svg
									className="md:w-[4rem] md:h-[4rem] md:-mt-[1rem]"
									xmlns="http://www.w3.org/2000/svg"
									width="32"
									height="32"
									viewBox="0 0 32 32"
						...
						<form className="container flex justify-center">
							<div className="max-w-[43.75rem] w-screen flex flex-row items-center justify-between border-b-[.0625rem] border-b-grey-600">
								<input
