...
export default function Footer() {
	return (
		<footer className="bg-white dark:bg-black">
			<div className="container py-[2.8rem] md:py-[4rem] xl:py-[5.8rem] flex flex-col items-center gap-y-[1.5rem] text-center relative">
          ...
          md:mt-[.4rem]"
				>
					...
					<span className="text-black dark:text-white"> VitaThemes</span>
				</p>
				<ul className="flex flex-row gap-x-[1.84rem]">
					<li>
						<a
